						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="product-status-wrap">
								...
								<form action="{{route('hoadon.updatetrangthai',$ds['id'])}}" method="POST">
									@csrf
									@method('PUT')
									<a href="{{route('hoadon.updatetrangthai',$ds['id'])}}"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
									</form>
										</div>
								...
								<div class="custom-pagination">
									<ul class="pagination" >
									{!! $dsHoaDon->withQueryString()->links() !!}
									</ul>
								</div>
							</div>
						</div>
