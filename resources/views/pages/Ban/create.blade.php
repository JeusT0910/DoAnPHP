                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> Create Bàn</a></li>
                                </ul>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Tên Bàn" name="tenban">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                ...
                                                <div class="review-content-section">
                                                    ...
                                                    <select name="loaiban" class="form-control pro-edt-select form-control-primary" id="loaiban">
                                                            ...
                                                            @foreach($LoaiBan as $i)
                                                                <option value="{{$i['id']}}">{{$i['TenLoaiBan']}}</option>
															@endforeach
														</select>
                                                    </br>
