							...
							<div class="product-status-wrap">
								...
								<table>
									...
									<tr>
										...
										<form action="{{route('donvitinh.updatetrangthai',$ds['id'])}}" method="POST">
										@csrf
										@method('PUT')
										<a href="{{route('donvitinh.updatetrangthai',$ds['id'])}}"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed" onclick="onCheck()"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
									</form>
