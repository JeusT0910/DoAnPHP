                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> Create món ăn</a></li>
                                </ul>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Tên món" name="TenMon">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Chi tiết" name="ChiTiet">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                ...
                                                <div class="review-content-section">
                                                    ...
                                                    <select name="danhmuc" class="form-control pro-edt-select form-control-primary" id="danhmuc">
                                                            ...
                                                            @foreach($danhmuc as $i) 
                                                                <option value="{{$i['id']}}">{{$i['TenDM']}}</option>
															@endforeach
														</select>
                                                    </br>
                                                    ...
                                                    <select name="donvitinh" class="form-control pro-edt-select form-control-primary" id="donvitinh">
                                                            ...
                                                            @foreach($donvi as $i) 
                                                                <option value="{{$i['id']}}">{{$i['TenDV']}}</option>
															@endforeach
														</select>
                                                        </br>
                                                        <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <img src="" alt="no img" id="imgsp" class="img-thumbnail">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
