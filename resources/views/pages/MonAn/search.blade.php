						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="product-status-wrap">
								...
								<form action="{{route('monan.updatetrangthai',$ds['id'])}}" method="POST" enctype="multipart/form-data">
									@csrf
									@method('PUT')
									<a href="{{route('monan.updatetrangthai',$ds['id'])}}"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
									</form>
										</div>
										</td>
									</tr>
