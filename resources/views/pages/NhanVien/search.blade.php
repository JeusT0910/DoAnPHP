							...
							<div class="product-status-wrap">
								...
								<table>
									...
									<tr>
										...
										<form action="{{route('nhanvien.updatetrangthai',$ds['id'])}}" method="POST">
									@csrf
									@method('PUT')
									<a href="{{route('nhanvien.updatetrangthai',$ds['id'])}}"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
									</form>
										</div>
								...
								<div class="custom-pagination">
									<ul class="pagination" >
									{!! $dsNhanVien->withQueryString()->links() !!}
									</ul>
								</div>
							</div>
						</div>
